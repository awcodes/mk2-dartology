...
import { registerRuntimeCompiler, initCustomFormatter, warn, ref, computed, defineComponent, h, Fragment, onMounted, watch, provide, inject, watchEffect, onUnmounted, Teleport, reactive, unref, nextTick, cloneVNode, openBlock, createBlock, createElementBlock, resolveDynamicComponent, withCtx, normalizeClass, createVNode, renderList, createCommentVNode, withModifiers, renderSlot, createElementVNode, createSSRApp } from "@vue/runtime-dom";
...
y[pa] = y[ha] = y[va] = y[ma] = y[ga] = y[ya] = y[ba] = y[wa] = y[Sa] = true;
y[Qn] = y[Zn] = y[fa] = y[ea] = y[da] = y[ta] = y[ra] = y[na] = y[aa] = y[oa] = y[ia] = y[sa] = y[la] = y[ua] = y[ca] = false;
function _a(e) {
...
const Xe = ref(1), fe = typeof window > "u";
function Xa(e, t) {
...
const br = ref({}), wr = ref({}), Sr = (e) => wr.value[e], to = (e) => Object.keys(Sr.value[e]).length > 0, _r = ref({}), ro = (e) => _r.value[e], $r = ref({}), no = (e) => $r.value[e], de = ref([]), ao = computed(() => Ja(de.value));
function oo(e) {
  de.value.push(e);
}
function io(e) {
  de.value[e].dismissed = true, de.value[e].html = null;
}
const vt = ref(null);
function so(e, t, r, n) {
  let a, o;
...
function go() {
  Te(I.value.url, "GET", {}, { "X-Splade-Refresh": true });
}
const Er = ref(() => {
}), Pr = ref(() => {
}), Ar = ref(() => {
  ...
  popStack: eo,
  currentStack: M,
  pageVisitId: computed(() => I.value.pageVisitId),
  isSsr: fe
};
function Cr(e, t) {
  return e && ht(e, gr(t));
...
const be = {
  ...
  setup(e) {
    ...
    return watch(() => t.html, n, { immediate: true }), (a, o) => (openBlock(), createBlock(unref(r)));
  }
}, bo = {
  __name: "ServerError",
  props: {
  ...
  setup(e) {
    ...
    return p.setOnHead((c) => {
      ...
      a.value = c;
    }), p.init(t.initialHtml, t.initialSpladeData), (c, d) => (openBlock(), createElementBlock("div", null, [
      (openBlock(), createBlock(resolveDynamicComponent(unref(p).isSsr ? "div" : "keep-alive"), {
        max: unref(s).max_keep_alive
      }, {
        default: withCtx(() => [
          (openBlock(), createBlock(be, {
            key: `visit.${unref(p).pageVisitId.value}`,
            class: normalizeClass({
              "transition ease-in-out blur-sm": unref(p).currentStack > 0
            }),
            html: r.value
          }, null, 8, ["class", "html"]))
        ]),
      ...
      createVNode(be, { html: e.components }, null, 8, ["html"]),
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(p).currentStack.value, (f) => (openBlock(), createBlock(be, {
        key: `modal.${f}`,
        type: n.value[f].type,
        html: n.value[f].html,
        stack: f,
        "on-top-of-stack": unref(p).currentStack.value === f,
        onClose: (v) => i(f)
      }, null, 8, ["type", "html", "stack", "on-top-of-stack", "onClose"]))), 128)),
      a.value ? (openBlock(), createBlock(bo, {
        key: 0,
        html: a.value,
        onClose: o
...
function bt(e, t) {
  if (R(e))
    return false;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || yt(e) ? true : Eo.test(e) || !To.test(e) || t != null && e in Object(t);
}
...
function x({ visible: e = true, features: t = 0, ourProps: r, theirProps: n, ...a }) {
  var o;
  ...
  if (t & 1) {
    ...
    return j(l, { [0]() {
      ...
      return Ke({ ...a, props: { ...i, hidden: true, style: { display: "none" } } });
    } });
  }
  return Ke(s);
}
...
`));
  ...
  return h(i, Object.assign({}, s, u), l);
}
function jr(e) {
  return e.flatMap((t) => t.type === Fragment ? jr(t.children) : [t]);
}
function $i(...e) {
  if (e.length === 0)
    return {};
...
function Di(e, t = 0) {
  var r;
  return e === ((r = he(e)) == null ? void 0 : r.body) ? false : j(t, { [0]() {
    return e.matches(Ye);
  }, [1]() {
    let n = e;
    for (; n !== null; ) {
...
function ji(e) {
  var t, r;
  return (r = (t = e == null ? void 0 : e.matches) == null ? void 0 : t.call(e, Fi)) != null ? r : false;
}
function Ri(e, t = (r) => r) {
...
function Ve(e, t, r = true) {
  ...
  let a = (n = Array.isArray(e) ? e.length > 0 ? e[0].ownerDocument : document : e == null ? void 0 : e.ownerDocument) != null ? n : document, o = Array.isArray(e) ? r ? Ri(e) : e : Ci(e), i = a.activeElement, s = (() => {
    ...
    if (t & 8)
      return o.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), u = t & 32 ? { preventScroll: true } : {}, c = 0, d = o.length, f;
  do {
    if (c >= d || c + d <= 0)
      return 0;
    let v = l + c;
...
function Qe(e, t, r) {
  typeof window < "u" && watchEffect((n) => {
    window.addEventListener(e, t, r), n(() => window.removeEventListener(e, t, r));
  });
}
function Bi(e, t, r = computed(() => true)) {
  function n(a, o) {
  ...
  Qe("click", (a) => n(a, (o) => o.target), true), Qe("blur", (a) => n(a, () => window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null), true);
}
var Be = ((e) => (e[e.None = 1] = "None", e[e.Focusable = 2] = "Focusable", e[e.Hidden = 4] = "Hidden", e))(Be || {});
let Ze = defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(e, { slots: t, attrs: r }) {
  return () => {
    let { features: n, ...a } = e, o = { "aria-hidden": (n & 2) === 2 ? true : void 0, style: { position: "absolute", width: 1, height: 1, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(n & 4) === 4 && (n & 2) !== 2 && { display: "none" } } };
...
let me = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let a = ref(null);
  n({ el: a, $el: a });
  let o = computed(() => he(a));
  Li({ ownerDocument: o }, computed(() => Boolean(e.features & 16)));
  let i = Mi({ ownerDocument: o, container: a, initialFocus: computed(() => e.initialFocus) }, computed(() => Boolean(e.features & 2)));
  qi({ ownerDocument: o, container: a, containers: e.containers, previousActiveElement: i }, computed(() => Boolean(e.features & 8)));
  let s = Ii();
  function l() {
    let u = G(a);
  ...
  return () => {
    ...
    return h(Fragment, [Boolean(d & 4) && h(Ze, { as: "button", type: "button", onFocus: l, features: Be.Focusable }), x({ ourProps: c, theirProps: { ...t, ...m }, slot: u, attrs: t, slots: r, name: "FocusTrap" }), Boolean(d & 4) && h(Ze, { as: "button", type: "button", onFocus: l, features: Be.Focusable })]);
  };
} }), { features: Nr });
function Li({ ownerDocument: e }, t) {
  let r = ref(null), n = { value: false };
  onMounted(() => {
    watch(t, (a, o) => {
      var i;
      a !== o && (!t.value || (n.value = true, r.value || (r.value = (i = e.value) == null ? void 0 : i.activeElement)));
    }, { immediate: true }), watch(t, (a, o, i) => {
      a !== o && (!t.value || i(() => {
        n.value !== false && (n.value = false, we(r.value), r.value = null);
      }));
    }, { immediate: true });
  });
}
...
function ki() {
  return inject(Hr, false);
}
let tt = defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(e, { slots: t, attrs: r }) {
  return provide(Hr, e.force), () => {
    let { force: n, ...a } = e;
...
let kr = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
  let n = ref(null), a = computed(() => he(n)), o = ki(), i = inject(Ur, null), s = ref(o === true || i == null ? Ui(n.value) : i.resolveTarget());
  return watchEffect(() => {
    ...
    return h(Teleport, { to: s.value }, x({ ourProps: l, theirProps: e, slot: {}, attrs: r, slots: t, name: "Portal" }));
  };
} }), Ur = Symbol("PortalGroupContext"), Gi = defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
...
function Ji({ slot: e = ref({}), name: t = "Description", props: r = {} } = {}) {
  let n = ref([]);
  function a(o) {
  ...
  return provide(Kr, { register: a, slot: e, name: t, props: r }), computed(() => n.value.length > 0 ? n.value.join(" ") : void 0);
}
defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" } }, setup(e, { attrs: t, slots: r }) {
  ...
  return onMounted(() => onUnmounted(n.register(a))), () => {
    let { name: o = "Description", slot: i = ref({}), props: s = {} } = n, l = e, u = { ...Object.entries(s).reduce((c, [d, f]) => Object.assign(c, { [d]: unref(f) }), {}), id: a };
...
let Ce = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", zr = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: Ce }, initialFocus: { type: Object, default: null } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: a }) {
  var o;
  let i = ref(false);
  onMounted(() => {
    i.value = true;
  });
  let s = ref(0), l = $t(), u = computed(() => e.open === Ce && l !== null ? j(l.value, { [oe.Open]: true, [oe.Closed]: false }) : e.open), c = ref(/* @__PURE__ */ new Set()), d = ref(null), f = ref(null), v = computed(() => he(d));
  ...
  let m = computed(() => i.value && u.value ? 0 : 1), $ = computed(() => m.value === 0), T = computed(() => s.value > 1), C = inject(nt, null) !== null, D = computed(() => T.value ? "parent" : "leaf");
  Hi(d, computed(() => T.value ? $.value : false)), zi({ type: "Dialog", element: d, onUpdate: (S, b, _) => {
    if (b === "Dialog")
      return j(S, { [rt.Add]() {
  ...
  let te = Ji({ name: "DialogDescription", slot: computed(() => ({ open: u.value })) }), J = `headlessui-dialog-${le()}`, F = ref(null), H = { titleId: F, panelRef: ref(null), dialogState: m, setTitleId(S) {
    F.value !== S && (F.value = S);
  }, close() {
    t("close", false);
  } };
  return provide(nt, H), Bi(() => {
    var S, b, _;
    ...
    H.close(), nextTick(() => b == null ? void 0 : b.focus());
  }, computed(() => m.value === 0 && !T.value)), qr((o = v.value) == null ? void 0 : o.defaultView, "keydown", (S) => {
    ...
    let S = { ...r, ref: d, id: J, role: "dialog", "aria-modal": m.value === 0 ? true : void 0, "aria-labelledby": F.value, "aria-describedby": te.value }, { open: b, initialFocus: _, ...g } = e, E = { open: m.value === 0 };
    return h(tt, { force: true }, () => [h(kr, () => h(Gi, { target: d.value }, () => h(tt, { force: false }, () => h(me, { initialFocus: _, containers: c, features: $.value ? j(D.value, { parent: me.features.RestoreFocus, leaf: me.features.All & ~me.features.FocusLock }) : me.features.None }, () => x({ ourProps: S, theirProps: g, slot: E, attrs: r, slots: n, visible: m.value === 0, features: Re.RenderStrategy | Re.Static, name: "Dialog" }))))), h(Ze, { features: Be.Hidden, ref: f })]);
  };
} });
defineComponent({ name: "DialogOverlay", props: { as: { type: [Object, String], default: "div" } }, setup(e, { attrs: t, slots: r }) {
  ...
  return () => x({ ourProps: { id: a, "aria-hidden": true, onClick: o }, theirProps: e, slot: { open: n.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogOverlay" });
} });
defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let a = Pe("DialogBackdrop"), o = `headlessui-dialog-backdrop-${le()}`, i = ref(null);
  return n({ el: i, $el: i }), onMounted(() => {
    if (a.panelRef.value === null)
      throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
    let s = e, l = { id: o, ref: i, "aria-hidden": true };
    return h(tt, { force: true }, () => h(kr, () => x({ ourProps: l, theirProps: { ...t, ...s }, slot: { open: a.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
  };
} });
let Wr = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" } }, setup(e, { attrs: t, slots: r, expose: n }) {
...
defineComponent({ name: "DialogTitle", props: { as: { type: [Object, String], default: "h2" } }, setup(e, { attrs: t, slots: r }) {
  ...
  return onMounted(() => {
    n.setTitleId(a), onUnmounted(() => n.setTitleId(null));
...
function Zi() {
  return inject(Ot, null) !== null;
}
function es() {
  let e = inject(Ot, null);
  if (e === null)
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  return e;
}
function ts() {
  let e = inject(Tt, null);
  if (e === null)
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  return e;
}
...
let Yr = Re.RenderStrategy, Ae = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: a }) {
  if (!Zi() && Pi())
  ...
  let o = ref(null), i = ref("visible"), s = computed(() => e.unmount ? V.Unmount : V.Hidden);
  a({ el: o, $el: o });
  let { show: l, appear: u } = es(), { register: c, unregister: d } = ts(), f = { value: true }, v = le(), m = { value: false }, $ = Xr(() => {
  ...
  function S(b) {
    ...
    !g || !(g instanceof HTMLElement) || _ || (m.value = true, l.value && t("beforeEnter"), l.value || t("beforeLeave"), b(l.value ? Gt(g, T, C, D, te, (E) => {
      m.value = false, E === at.Finished && t("afterEnter");
    }) : Gt(g, J, F, H, te, (E) => {
      m.value = false, E === at.Finished && (Ne($) || (i.value = "hidden", d(v), t("afterLeave")));
    })));
  }
  return onMounted(() => {
    watch([l], (b, _, g) => {
  ...
  }), provide(Tt, $), Ai(computed(() => j(i.value, { visible: oe.Open, hidden: oe.Closed }))), () => {
...
} }), rs = Ae, xe = defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
  let a = $t(), o = computed(() => e.show === null && a !== null ? j(a.value, { [oe.Open]: true, [oe.Closed]: false }) : e.show);
  watchEffect(() => {
    if (![true, false].includes(o.value))
      throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
  });
  let i = ref(o.value ? "visible" : "hidden"), s = Xr(() => {
    i.value = "hidden";
  }), l = ref(true), u = { show: o, appear: computed(() => e.appear || !l.value) };
  return onMounted(() => {
    watchEffect(() => {
      l.value = false, o.value ? i.value = "visible" : Ne(s) || (i.value = "hidden");
    });
  }), provide(Tt, s), provide(Ot, u), () => {
    let c = Rr(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), d = { unmount: e.unmount };
    return x({ ourProps: { ...d, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h(rs, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...d, ...c }, n.default)] }, attrs: {}, features: Yr, visible: i.value === "visible", name: "Transition" });
  };
} });
const ns = {
  props: {
  ...
  methods: {
    cancel() {
      p.confirmModal.value.rejectPromise(), this.setIsOpen(false);
    },
    confirm() {
      p.confirmModal.value.resolvePromise(), this.setIsOpen(false);
    },
    setIsOpen(e) {
      this.isOpen = e;
    },
...
function an(e) {
  return e === true || e === false || Z(e) && ee(e) == hs;
}
function vs() {
...
function on(e, t, r, n, a, o) {
  ...
  if (u && c)
    return u == t && c == e;
  var d = -1, f = true, v = r & Ps ? new Ie() : void 0;
...
function rl(e, t, r, n, a, o) {
  ...
  if ($ && !T) {
    ...
    J != F && "constructor" in e && "constructor" in t && !(typeof J == "function" && J instanceof J && typeof F == "function" && F instanceof F) && ($ = false);
  }
...
function vl(e, t, r, n, a, o) {
  ...
  return f ? (o || (o = new U()), rl(e, t, r, n, a, o)) : false;
}
function Pt(e, t, r, n, a) {
  return e === t ? true : e == null || t == null || !Z(e) && !Z(t) ? e !== e && t !== t : vl(e, t, r, n, Pt, a);
}
var ml = 1, gl = 2;
function yl(e, t, r, n) {
  ...
  methods: {
    ...
    request() {
      ...
      p.request(this.action, this.method.toUpperCase(), e, {
        ...
        this.$emit("success", t), this.restoreOnSuccess && this.restore(), this.resetOnSuccess && this.reset(), this.processing = false, this.wasSuccessful = true, this.recentlySuccessful = true, this.recentlySuccessfulTimeoutId = setTimeout(() => this.recentlySuccessful = false, 2e3);
      }).catch((t) => {
        this.processing = false, this.$emit("error", t);
      });
    }
  },
  render() {
...
`));
  ...
  install: (e, t) => {
    t = t || {}, t.max_keep_alive = L(t, "max_keep_alive") ? t.max_keep_alive : 10, t.prefix = L(t, "prefix") ? t.prefix : "Splade", t.transform_anchors = L(t, "transform_anchors") ? t.transform_anchors : false, t.link_component = L(t, "link_component") ? t.link_component : "Link";
    const r = t.prefix;
...
Gl(createServer, renderToString, (props) => {
  return createSSRApp({
    render: Hl(props)
  }).use(Ul);
});
